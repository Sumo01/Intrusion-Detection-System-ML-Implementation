...
def create():
    ...
    for packet in capture:
        packet_dict = {}
        packet_dict['protocol_type'] = 'icmp' if packet.ip.proto == 2 else 'tcp' if packet.ip.proto == 6 else 'udp' if packet.ip.proto == 17 else 0
        packet_dict['service'] = packet.tcp.highest_layer
